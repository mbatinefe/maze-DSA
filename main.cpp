...
// if isRoadChoose is false, it is for maze creation
// If isRoadChoose is true, it is for road creation
        ...
        if(selected[random] == 0){
            ...
            switch (random){
                case 0:
                    ...
                    } else{ // If it is for road creation
